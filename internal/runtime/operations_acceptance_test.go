...
func TestOperationsRecovery(t *testing.T) {
	...
	t.Run("migration projection token and role recovery", func(t *testing.T) {
		...
		if schemaVersion != 19 {
			t.Fatalf("expected schema version 19 after replay, got %d", schemaVersion)
		}
	...
	t.Run("schema 19 retrieval dump restore and disposable rebuild", func(t *testing.T) {
