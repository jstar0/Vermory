...
- [ ] **Step 1: Verify formal-run prerequisites without printing secrets.**
...
- [ ] **Step 2: Run the formal profile once from a clean root.**
...
- [ ] **Step 3: Replay the completed run ID.**
...
- [ ] **Step 4: Independently inspect evidence.**
...
- [ ] **Step 5: Commit normalized evidence and product boundaries.**
...
- [ ] **Step 2: Mark every completed plan checkbox and commit the checklist.**
