...
- Evidence needed: calibrated quality/latency thresholds, source-authority ranking, embedding migration, scale/fault qualification, and optional rerank comparison on a sealed or externally held corpus.
